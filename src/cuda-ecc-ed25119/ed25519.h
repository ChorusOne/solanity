...
void ED25519_DECLSPEC ed25519_verify_many(const gpu_Elems* elems, uint32_t num, uint32_t message_size, uint32_t public_key_offset, uint32_t signature_offset, uint32_t message_start_offset, uint32_t message_len, uint32_t packet_size, uint8_t* out);
